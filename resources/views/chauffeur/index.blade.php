...
<body class="bg-gray-100">
    ...
    <main class="lg:ml-64 p-8">
        ...
        <div class="grid grid-cols-2 max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
            <div class="p-5">
                <a href="#">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{ $dispo->titre ?? 'Pas de titre' }}</h5>
                </a>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Début : {{ $dispo->dateDebut }}</p>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Fin : {{ $dispo->dateFin }}</p>
                ...
                <div class="flex space-x-2">
                    ...
                    <form action="{{ route('chauffeur.destroy', $dispo->id) }}" method="post" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cette disponibilité ?');">
                        @csrf
                        @method('DELETE')
